...
@Component({
  ...
  template: `
    <div class="rounded-2xl border border-cloud bg-white shadow-sm p-10 text-center max-w-md mx-auto mt-6">
      ...
      <h1 class="font-display text-3xl mt-4">Einstein</h1>
      <p class="text-muted mt-2">The Science room — content and flow not designed yet.</p>
    </div>
  `,
})
export default class EinsteinComponent {}
